...
![cytoscape result](images/results_non_threshold.GseaPreranked.png)
<br/>
**Figure 6:** Figure for the different gene sets analysed as a publication ready figure.
<br/>
<br/>


![cytoscape result](images/legened_fig_6.png)
<br/>
**Figure 7:** Legend for pathways network in figure 6
<br/>
<br/>
...
**Question 8: Present your results with the use of tables and screenshots. All figures should have appropriate figure legends. If using figures create a figures directory in your repo and make sure all references to the figures are relative in your Rmarkdown notebook.** <br/>
...
Figure: Wikipathway DNA Double-Strand Break Repair pathway which is the path number 5693532 on wikipathways
...
Figure: GeneMania of the DNA Double-Strand Break Repair pathway overlayed with the rank data. BRCA1 is downregulated as seen in the figure, and is highlighted in Yellow.


![cytoscape result](images/fig6.png)
Figure: Close up of GeneMania of the DNA Double-Strand Break Repair pathway overlayed with the rank data. BRCA1 is downregulated as seen in the figure. 
