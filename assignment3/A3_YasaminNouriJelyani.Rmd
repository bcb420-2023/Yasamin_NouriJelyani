...
#TODO: how do I summrize with graphs and words?
...
From the network results, it is evident that the up-regulated genes do not significantly map to the geneset pathways and as expected, the up-regulated genes have many nodes in the graph representation were the focus group of the study. 
...
# TODO ask for gsea, bader lab, cytoscape bib ref
