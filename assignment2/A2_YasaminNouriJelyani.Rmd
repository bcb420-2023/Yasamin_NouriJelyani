...
There are multiple methods to perfom this task. I chose G:profiler because it is updated,
has a webserver as well as an R package, and it is used to perform ORA analysis. 
<br/>
